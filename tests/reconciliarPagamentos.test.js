...
import { reconciliarPagamentosAposEdicao, resumoParcelas } from '../src/dominio.js';
...
test('parcela que voltou a pendente remove o registro órfão', () => {
  const divida = {
    id: 'd2',
    parcelas: [
      { id: 'p9', numero: 1, valor: 150, status: 'pendente', valorPago: 0, dataPagamento: '' },
    ],
  };
  const pagamentos = [
    {
